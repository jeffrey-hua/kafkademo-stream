package com.lh.kafka.stream.producer;

import com.lh.kafka.model.Item;
import com.lh.kafka.stream.serdes.GenericSerializer;
...
public class ItemProducer {
	...
	public static void main(String[] args) throws Exception {
		...
		props.put("bootstrap.servers", "192.168.118.149:9092");
		props.put("acks", "all");
		props.put("retries", 3);
		...
		items.forEach((Item item) -> producer.send(new ProducerRecord<String, Item>("items", item.getName(), item)));
		producer.close();
	}
